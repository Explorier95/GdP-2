 ...
 * @author Gert Veltink, updated Agathe Merceron, update Fabian Tappendorf
 *
 */
...
public class MRectangle extends MShape {
     ...
     * @update habe ich angepasst, Vorgabe war falsch, bitte weiterleiten an Skriptverantwortliche...
     */
	@Override
    public double area() {
